...
In the 21st century, I believe most of us have heard about the heated concept of Machine learning. But what is it? Machine learning is a method of data analysis that automates analytical model building. It enables us to quickly and automatically produce models that can analyze bigger, more complex data and deliver faster, more accurate results. 
